...
values
  ('pugilist_crystal_rose_skin', '크리스털 로즈 권투사', 'avatar', 2000, '◆',
   '장미빛 결정 건틀릿과 금장 전투복으로 모습을 바꾸는 여성 권투사 전용 스킨입니다. 전용 펀치와 피격 애니메이션이 적용됩니다.',
   false, true, 'skin', 'legendary', 5, null, 0,
   'assets/avatars/skins/pugilist-female-crystal-rose.webp')
